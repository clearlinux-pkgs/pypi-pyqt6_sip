...
Source0  : https://files.pythonhosted.org/packages/23/fd/530e274c4d7d39645478156063de266d7d3c1fb70ba9f38372a75094ed51/PyQt6_sip-13.5.0.tar.gz
...
%prep
%setup -q -n PyQt6_sip-13.5.0
cd %{_builddir}/PyQt6_sip-13.5.0
pushd ..
cp -a PyQt6_sip-13.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681145097
