...
Source0  : https://files.pythonhosted.org/packages/90/18/0405c54acba0c8e276dd6f0601890e6e735198218d031a6646104870fe22/pyqt6_sip-13.10.0.tar.gz
...
%prep
%setup -q -n pyqt6_sip-13.10.0
cd %{_builddir}/pyqt6_sip-13.10.0
pushd ..
cp -a pyqt6_sip-13.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738596816
