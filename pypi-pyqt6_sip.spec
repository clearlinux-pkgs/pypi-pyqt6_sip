...
Source0  : https://files.pythonhosted.org/packages/1e/24/99d1f9938afd58cf2d6120454cb36214bd76e18443b130b80b09fb368579/PyQt6_sip-13.4.1.tar.gz
...
%prep
%setup -q -n PyQt6_sip-13.4.1
cd %{_builddir}/PyQt6_sip-13.4.1
pushd ..
cp -a PyQt6_sip-13.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674943783
